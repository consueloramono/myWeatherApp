...
private String defaultCity = "Київ";
        ...
        searchBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (cityET.getText().toString().trim().equals(""))
                    Toast.makeText(MainActivity.this, "Напишіть назву міста", Toast.LENGTH_SHORT).show();
                else {
    ...
    private void updateWeatherData(String city) {
        String key = "4e751e2480d0ba5f881c7d404a225b77";
    ...
    private void updateForecastrData(String city) {
        String key = "4e751e2480d0ba5f881c7d404a225b77";
        String url = "https://api.openweathermap.org/data/2.5/forecast?q=" + city + "&appid=" + key + "&units=metric&lang=ua";
            ...
            protected void onPostExecute(String result) {
                ...
                try {
                    ...
                    if (jsonObject.has("cod")) {
                        ...
                        if (responseCode == 404) {
                            Toast.makeText(MainActivity.this, "Місто не знайдено", Toast.LENGTH_SHORT).show();
                            return;
                        }
                    }
        ...
        next7dayBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!city.isEmpty()) {
                    ...
                    Toast.makeText(MainActivity.this, "Введіть місто", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private class FetchWeatherTask extends AsyncTask<String, Void, ArrayList<Hourly>> {
        ...
        protected ArrayList<Hourly> doInBackground(String... strings) {
            ...
            try {
                String apiKey = "4e751e2480d0ba5f881c7d404a225b77";
                String city = cityET.getText().toString().trim();
